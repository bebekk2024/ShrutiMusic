...
REPO_VIDEO = "https://files.catbox.moe/7svpoz.mp4"
...
async def send_repo(_, message: Message):
    await message.reply_video(
        ...
        caption=(
            ...
            "🧡 ᴄʀᴇᴅɪᴛꜱ : <a href='https://t.me/Capricorn_MusicBot'>@mhmdwldnnnn</a>"
        ),
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📂 Management Bot", url="https://t.me/mhmdwldnnnn"),
                    InlineKeyboardButton("📂 Music Bot", url="https://t.me/Capricorn_MusicBot")
                ]
            ]
        ),
        supports_streaming=True,
