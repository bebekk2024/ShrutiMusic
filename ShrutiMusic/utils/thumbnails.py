...
# https://github.com/NoxxOP/ShrutiMusic/blob/main/ShrutiMusic/utils/thumbnails.py
# Modified to replace top-left label with "Capricorn Music"
...
# Top-left label text (change here if needed)
TOP_LEFT_LABEL = "Capricorn Music"  # <<-- changed from "ShrutiMusic"
...
async def gen_thumb(videoid: str):
    ...
    try:
        ...
        # top-left label (updated to use TOP_LEFT_LABEL)
        tl_font = ImageFont.truetype(FONT_BOLD_PATH, 34)
        draw.text((28+1, 18+1), TOP_LEFT_LABEL, fill=TEXT_SHADOW, font=tl_font)
        draw.text((28, 18), TOP_LEFT_LABEL, fill=TEXT_WHITE, font=tl_font)
