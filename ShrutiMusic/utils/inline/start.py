...
def start_panel(_):
    buttons = [
        ...
        [
            InlineKeyboardButton(text=_["E_X_1"], url=config.USERBOT),
...
def owner_panel(_):
    buttons = [
        [
            ...
            InlineKeyboardButton(text=_["S_H_2"], url=config.TIKTOK),
        ],
        [
            InlineKeyboardButton(text=_["S_H_3"], url=config.USERBOT),
